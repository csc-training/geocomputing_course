...
Let's all check now at [https://my.csc.fi](https://my.csc.fi) that you see the course project, and have accepted the terms and conditions of Puhti and Allas. We will need this later.
...
```{figure} images/familiarity.png
:alt: Familiarity of course participants with different topics related to this course
:width: 700px
:align: center
...
```{figure} images/computer_usage.png
:alt: Computer usage of course participants
:width: 700px
:align: center
...
We strive to follow the [Contributor Covenant Code of Conduct](https://www.contributor-covenant.org/) to foster an inclusive and welcoming environment for everyone.
...
This CoC text is provided by [ENCCS instructor training](https://enccs.github.io/instructor-training/).
