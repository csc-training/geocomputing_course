...
* Basic Unix commands (know how to use these commands in a terminal): ```cd, ls, mv, cp, rm, chmod, less, tail, echo, mkdir, pwd``````.
    * Here are some resources to acquire these skills:
        ...
        * [CSC and Linux Cheat Sheet](https://docs.csc.fi/img/csc-quick-reference/csc-quick-reference.pdf) (one page summary of the most important Linux commands – handy to have near you during the course)
